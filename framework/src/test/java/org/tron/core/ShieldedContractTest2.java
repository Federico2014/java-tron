...
//    int endNum = 45920;
  ...
  @Test
  public void testECDSA() throws SignatureException {
    String rawData =
        "";
    ECKey ecKey = ECKey.fromPrivate(Hex.decode(privateKey));
    byte[] hash = Sha256Hash.hash(DBConfig.isECKeyCryptoEngine(), Hex.decode(rawData));
    ECDSASignature signature = ecKey.sign(hash);
    byte[] expectedAddress = ecKey.getAddress();
    long startTime = System.currentTimeMillis();
    for (int i = 0; i < 10000; i++) {
      byte[] recoverAddress = ECKey.signatureToAddress(hash, signature);
      Assert.assertArrayEquals(expectedAddress, recoverAddress);
    }
    long endTime = System.currentTimeMillis();
    System.out.println("ecdsa signature verify time: " + (endTime - startTime) / 10000 + "ms");
    logger.info(Hex.toHexString(signature.toByteArray()));
